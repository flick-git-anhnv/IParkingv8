...
{
    public class ConfirmPlateMonthlyPresenter
    {
        IConfirmPlateMonthlyView _view;
        ...
        public ConfirmPlateMonthlyPresenter(IConfirmPlateMonthlyView view)
        {
            _view = view;
        ...
        {
            _view.SetTitleText(KZUIStyles.CurrentResources.PlateSame);
