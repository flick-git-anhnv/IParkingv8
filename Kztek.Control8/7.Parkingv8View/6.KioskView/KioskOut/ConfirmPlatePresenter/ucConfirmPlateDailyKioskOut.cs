...
{
    public partial class ucConfirmPlateDailyKioskOut : UserControl, IConfirmPlateDailyView
    {
        ...
        public ucConfirmPlateDailyKioskOut(Image? defaultImage)
        {
            InitializeComponent();
        ...
        {
            ClearView();
            DisplayEventInforInternal(exitData, displayImage, errorMessage);
            CenterControlLocation();
            ShowDialog();
        }
        private void DisplayEventInforInternal(ExitData exitData, Image? displayImage, string errorMessage)
        {
            this.Invoke(this.SuspendLayout);
