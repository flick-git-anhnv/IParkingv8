...
{
    public partial class UcConfirmOutSmall : UserControl, IDialog<ConfirmOutRequest, ConfirmOutResult>, KzITranslate
    {
        #region PROPERTIES
        //[BASE]
        ...
        #region CONSTRUCTOR
        public UcConfirmOutSmall(IAPIServer apiServer, List<Collection> dailyCollections, LaneOptionalConfig laneOptionalConfig, IQRDevice qRViewDevice, User? user)
        {
            InitializeComponent();
        ...
        private async void BtnChangeCollectionType_Click(object? sender, EventArgs e)
        {
            try
            {
                ...
                if (newInfo != null)
                {
                    ...
                    //btnPayQR.Visible = fee > 0 && this.LaneOptionalConfig.IsUseQRViewDevice;
                }
                else
                {
        ...
        public async Task<ConfirmOutResult> ShowDialog(ConfirmOutRequest request, Form maskedForm)
        {
            ...
            //btnPayQR.Visible = this.LaneOptionalConfig.IsUseQRViewDevice;
        ...
        private void Responsive()
        {
            ...
            //lblParkingTime.Width = lblParkingFee.Width = txtDetectPlate.Width;
