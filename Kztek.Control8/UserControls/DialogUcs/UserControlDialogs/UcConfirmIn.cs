...
{
    public partial class UcConfirmIn : UserControl, IDialog<ConfirmInRequest, ConfirmPlateResult>, KzITranslate
    {
        #region Properties
        ...
        #region Properties
        public UcConfirmIn(LaneOptionalConfig laneOptionalConfig, Image? defaultImage)
        {
            InitializeComponent();
        ...
        public void Translate()
        {
            ...
            lblVehicleTypeNameTitle.Text = KZUIStyles.CurrentResources.VehicleType;
        ...
        private void Responsive()
        {
            ...
            lblVehicleType.Width = lblTimeIn.Width = (this.Width - padding * 3) / 2;
            ...
            lblPlateAlarmTitle.Location = new Point(kzuI_UcImageVehicle.Location.X, lblPlateAlarmTitle.Location.Y);
            lblAlarmPlate.Location = new Point(kzuI_UcImageVehicle.Location.X, lblAlarmPlate.Location.Y);
            btnCopy.Location = new Point(lblAlarmPlate.Right + 8, btnCopy.Location.Y);

            lblVehicleTypeNameTitle.Location = new Point(kzuI_UcImageVehicle.Location.X, lblVehicleTypeNameTitle.Location.Y);
            lblVehicleType.Location = new Point(kzuI_UcImageVehicle.Location.X, lblTimeIn.Location.Y);
        ...
        private void UpdateView(EmAlarmCode abnormalCode, string message, AccessKey? accessKey, string alarmPlate, string plateNumber, Dictionary<EmImageType, Image?> images)
        {
            ...
            lblVehicleType.Text = accessKey?.Collection?.GetVehicleTypeName() ?? "";
