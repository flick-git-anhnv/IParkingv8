...
namespace TcpipIntface.Code.Client
{
    ...
    class TcpPackge
    {
        ...
        //public byte[] ChinaImage = new byte[1024];
        ...
        #region 事件声明
        public delegate void TOnEventHandler(RAcsEvent Event, out byte relay, out Boolean OpenDoor, out Boolean Ack);   //声明委托 
        ...
        public event TOnChinaEventHandler OnChinaEventHandler;        //声明事件
