...
namespace TiandyNetClient
{
    ...
    {       
        ...
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetCommonEnable(Int32 _iLogonID, Int32 _iEnableID, Int32 _iChannel, ref Int32 _iEnableValue);
        [DllImport("NVSSDK.dll")]
        ...
        // user management
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetUserNum(Int32 _iLogonID, ref Int32 _iNum);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetUserInfo(Int32 _iLogonID, Int32 _iUserSerial, byte[] _btUsername, byte[] _btPassword, ref Int32 _iAuthority);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetCurUserInfo(Int32 _iLogonID, byte[] _cUserName, byte[] _cPassword, ref Int32 _iAuthority);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_AddUser(Int32 _iLogonID, string _strUserName, string _strPassword, int _iAuthority);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_DelUser(Int32 _iLogonID, string _strUserName);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_ModifyPwd(Int32 _iLogonID, string _strUserName, string _strNewPwd);
        
        // Authority
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetUserAuthority(Int32 _iLogonID, string _strUserName, IntPtr _lpBuf, Int32 _iBufSize);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetGroupAuthority(Int32 _iLogonID, IntPtr _lpBuf, Int32 _iBufSize);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_ModifyUserAuthority(Int32 _iLogonID, string _strUserName, IntPtr _lpBuf, Int32 _iBufSize);
        [DllImport("NVSSDK.dll")]
        ...
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetDevConfig(Int32 _iLogonID, Int32 _iCommand, Int32 _iChannel, IntPtr _lpOutBuffer, Int32 _iOutBufferSize, ref Int32 _iReturnedSize);
        
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_SendCommand(Int32 _iLogonID, Int32 _iCommand, Int32 _iChannel, IntPtr _pBuffer, Int32 _iBufferSize);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_RecvCommand(Int32 _iLogonID, Int32 _iCommand, Int32 _iChannel, IntPtr _pBuffer, Int32 _iBufferSize);

        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_SetDomePTZ(Int32 _iLogonID, Int32 _iChannelNo, IntPtr _lpBuf, Int32 _iBufSize);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetDomePTZ(Int32 _iLogonID, Int32 _iChannelNo, IntPtr _lpBuf, Int32 _iBufSize);
        [DllImport("NVSSDK.dll")]
        ...
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_CapturePicData(UInt32 _ulConID, Int32 _iPicType, byte[] _pcPicBuf, ref Int32 _piPicSize);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_CapturePic(UInt32 _ulConID,ref IntPtr _pucData);
        [DllImport("NVSSDK.dll")]
        public static extern Int32 NetClient_GetLogonStatus(int _iLogonID);
