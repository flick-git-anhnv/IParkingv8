using Futech.Objects.Ingress;
using Futech.Objects.KZE02NETControllerv2;
using Futech.Objects.KZE16AccessControl;
    ...
    public class Line
    {
        ...
        public bool Start()
        {
            switch (lineTypeID)
            {
                ...
                case 40:
                    {
                        controllerSettingPage = new IngressSettingPage();
                        break;
                    }
                case 43:
                    {
                ...
                case 74: // BDK KzE05.NET giao tiep bo nha the	
                    {
                        controllerSettingPage = new KZE16SettingPage();
                        break;
                    }
            }
