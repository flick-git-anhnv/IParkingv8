...
namespace PrintControl
{
    public partial class ControlPrint : PrintDocument
    {
        ...
        public ControlPrint(string[] row)
        {
            // make control
            ListBox listBox = new ListBox();
            listBox.Size = new Size(200, 150);
            listBox.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            listBox.Items.AddRange(row);
            // init
            InitializeComponent();
            SetControl(listBox);
            stretch = false;
