...
{
    public partial class KZE02NETv2SettingPage : Form, IControllerSettingPage
    {
        private KZE02NETv2 Fat810W = new KZE02NETv2();

        public event CardEventHandler CardEvent;
        public event InputEventHandler InputEvent;
        public KZE02NETv2SettingPage()
        {
            InitializeComponent();
        ...
        {
            Fat810W.OpenRelay(outputNo, delay);
            return false;
        }
