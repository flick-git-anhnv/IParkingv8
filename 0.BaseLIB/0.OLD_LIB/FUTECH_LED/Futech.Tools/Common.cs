            ...
            Task.Run(() =>
            {
                ...
                catch (Exception ex)
                {
                    LogHelper.Log(logType: LogHelper.EmLogType.ERROR,
                                  ...
                                  action: "DeleteFoldersByCreatedTime",
                                  obj: ex);
                    throw;
                }
            });
