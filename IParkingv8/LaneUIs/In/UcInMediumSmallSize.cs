...
{
    public partial class UcInMediumSmallSize : UcBaseLaneIn
    {
        public List<UISplitContainer> activeSpliters = [];

        public UcInMediumSmallSize(Lane lane, KZUI_UcEventRealtime ucEventRealtime) : base(lane, ucEventRealtime)
        {
            InitializeComponent();
