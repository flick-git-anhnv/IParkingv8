...
{
    public partial class UcInSmallSize : UcBaseLaneIn
    {
        public List<UISplitContainer> activeSpliters = [];

        public UcInSmallSize(Lane lane, KZUI_UcEventRealtime ucEventRealtime) : base(lane, ucEventRealtime)
        {
            InitializeComponent();
        ...
        public void CreateUI()
        {
            ...
            UcAppFunctions.Init(iParkingv8.Object.Enums.Bases.EmLaneType.LANE_IN, EmControlSizeMode.SMALL);
