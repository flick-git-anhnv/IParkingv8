...
{
    public partial class UcOutMediumSmallSize : UcBaseLaneOut
    {
        public List<UISplitContainer> activeSpliters = [];
        public UcOutMediumSmallSize(Lane lane, LaneDisplayConfig laneDisplayConfig, KZUI_UcEventRealtime ucEventRealtime) : base(lane, ucEventRealtime)
        {
            InitializeComponent();
            this.SizeMode = EmControlSizeMode.SMALL;
            this.Lane = lane;
        ...
        public void CreateUI()
        {
            ...
            ucEventInfoNew.KZUI_ControlSizeMode = SizeMode;

            this.panelAppFunction.Controls.Add(UcAppFunctions);
            UcAppFunctions.Dock = DockStyle.Fill;
            UcAppFunctions.Init(iParkingv8.Object.Enums.Bases.EmLaneType.LANE_OUT, EmControlSizeMode.MEDIUM);
        ...
        public override void ChangeLaneDirectionConfig(LaneDirectionConfig config)
        {
            ...
            UcEventImageListOut.KZUI_IsDisplayPanorama = config.IsDisplayPanoramaImage && this.Lane.Cameras.FirstOrDefault(e => e.Purpose == (int)EmCameraPurpose.Panorama) != null;
            UcEventImageListOut.KZUI_IsDisplayVehicle = config.IsDisplayVehicleImage && this.Lane.Cameras.FirstOrDefault(e => e.Purpose == (int)EmCameraPurpose.CarLpr || e.Purpose == (int)EmCameraPurpose.MotorLpr) != null;
            UcEventImageListOut.KZUI_IsDisplayFace = config.IsDisplayFaceImage && this.Lane.Cameras.FirstOrDefault(e => e.Purpose == (int)EmCameraPurpose.FaceID) != null;
            UcEventImageListOut.KZUI_IsDisplayOther = config.IsDisplayOtherImage && this.Lane.Cameras.FirstOrDefault(e => e.Purpose == (int)EmCameraPurpose.Other) != null;
