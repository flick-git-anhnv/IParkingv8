...
{
    public partial class UcOutSmallSize : UcBaseLaneOut
    {
        public List<UISplitContainer> activeSpliters = [];
        public UcOutSmallSize(Lane lane, LaneDisplayConfig laneDisplayConfig, KZUI_UcEventRealtime ucEventRealtime) : base(lane, ucEventRealtime)
        {
            InitializeComponent();
            this.Lane = lane;
        ...
        public void CreateUI()
        {
            ...
            this.panelUcResult.MinimumSize = this.panelUcResult.MaximumSize = UcResult.MaximumSize;
            ...
            UcAppFunctions.Init(EmLaneType.LANE_OUT, EmControlSizeMode.SMALL);
            this.panelAppFunction.MinimumSize = this.panelAppFunction.MaximumSize = UcAppFunctions.MaximumSize;
