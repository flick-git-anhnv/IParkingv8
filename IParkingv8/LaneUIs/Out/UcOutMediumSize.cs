...
namespace IParkingv8.LaneUIs.Out
{
    public partial class UcOutMediumSize : UcBaseLaneOut
    {
        public List<UISplitContainer> activeSpliters = [];
        public UcOutMediumSize(Lane lane, LaneDisplayConfig laneDisplayConfig, KZUI_UcEventRealtime ucEventRealtime) : base(lane, ucEventRealtime)
        {
            InitializeComponent();
        ...
        {
            panelBack.BorderColor = ColorManagement.LaneOutColor;

            if (this.SizeMode == EmControlSizeMode.SMALL)
            {
                this.dialogConfirmOut = new UcConfirmOutSmall(AppData.ApiServer, AppData.DailyAccessKeyCollections, this.laneOptionalConfig, this.QrDevice, StaticPool.SelectedUser);
            }
            else
            {
                this.dialogConfirmOut = new UcConfirmOut(AppData.ApiServer, AppData.DailyAccessKeyCollections, this.laneOptionalConfig, this.QrDevice, StaticPool.SelectedUser, defaultImg);
            }
            ...
            UcEventImageListOut!.Init(defaultImg);
            ((Control)UcEventImageListOut).Dock = DockStyle.Fill;
            UcEventImageListOut.Init(SizeMode);
            ...
            UcAppFunctions.Init(EmLaneType.LANE_OUT, EmControlSizeMode.MEDIUM);
        ...
        public override void ChangeLaneDirectionConfig(LaneDirectionConfig config)
        {
            ...
            //Khung sự kiện
            ucEventInfoNew.KZUI_IsDisplayMoney = config.optionViewData == EmViewOption.DataAndMoney;
            ...
            switch (config.PlateInDirection)
            {
                case LaneDirectionConfig.EmPlateDirection.Vertical:
                    UcPlateIn = new KZUI_UcPlateVertical() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ VÀO" };
                    break;
                case LaneDirectionConfig.EmPlateDirection.HorizontalLeftToRight:
                    UcPlateIn = new KZUI_UcPlateHorizontal() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ VÀO", KZUI_IsLeftoToRight = true };
                    break;
                case LaneDirectionConfig.EmPlateDirection.HorizontalRightToLeft:
                    UcPlateIn = new KZUI_UcPlateHorizontal() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ VÀO", KZUI_IsLeftoToRight = false };
                    break;
                default:
                    UcPlateIn = new KZUI_UcPlateVertical() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ VÀO" };
                    break;
            ...
            {
                case LaneDirectionConfig.EmPlateDirection.Vertical:
                    UcPlateOut = new KZUI_UcPlateVertical() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ RA" };
                    break;
                case LaneDirectionConfig.EmPlateDirection.HorizontalLeftToRight:
                    UcPlateOut = new KZUI_UcPlateHorizontal() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ RA", KZUI_IsLeftoToRight = true };
                    break;
                case LaneDirectionConfig.EmPlateDirection.HorizontalRightToLeft:
                    UcPlateOut = new KZUI_UcPlateHorizontal() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ RA", KZUI_IsLeftoToRight = false };
                    break;
                default:
                    UcPlateOut = new KZUI_UcPlateVertical() { KZUI_ControlSizeMode = this.SizeMode, KZUI_Title = "BIỂN SỐ RA" };
                    break;
