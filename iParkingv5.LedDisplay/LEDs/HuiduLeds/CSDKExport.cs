...
namespace iParkingv5.LedDisplay.LEDs.HuiduLeds
{
    ...
    {
        const string LIBRARYNETSDK = "./HuiduLedLib/HDSDK.dll";

        // Get last error
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_GetSDKLastError", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_GetSDKLastError();

        // Create screen
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_CreateScreen", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add program 
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddProgram", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add area
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddArea", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add image area item
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddImageAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add text area item
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddSimpleTextAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // Add time area item
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddTimeAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_CreateRealtimeArea", CallingConvention = CallingConvention.StdCall)]
        ...
        // Send command
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_SendCommand", CallingConvention = CallingConvention.StdCall)]
        ...
        // Send screen
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_SendScreen", CallingConvention = CallingConvention.StdCall)]
        ...
        // Send realtime area
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_SendRealTimeArea", CallingConvention = CallingConvention.StdCall)]
        ...
        // Get Color value
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_GetColor", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_GetColor(int r, int g, int b);

        // Save screen to disk
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_SaveScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_SaveScreen(IntPtr pDirPath);

        // command 
        // Get baudrate
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_GetBaudRate", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_GetBaudRate(int nPort, ref int pBaudRate, IntPtr pDeviceGUID);

        // Set baudrate
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_SetBaudRate", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_SetBaudRate(int nPort, int nSrcBaudRate, int nDestBaudRate, IntPtr pDeviceGUID);

        // Is card online
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_IsCardOnline", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_IsCardOnline(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // Clear screen
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_ClearScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_ClearScreen(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // Restart card
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_RestartCard", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_RestartCard(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // Test screen
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_TestScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_TestScreen(int nSendType, IntPtr pStrParams, int nStyle, IntPtr pDeviceGUID);

        // adjust time
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_AdjustTime", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_AdjustTime(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // set luminance
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_SetLuminance", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_SetLuminance(int nSendType, IntPtr pStrParams, int nLuminance, IntPtr pDeviceGUID);

        // screen ctrl
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_ScreenCtrl", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_ScreenCtrl(int nSendType, IntPtr pStrParams, int nCtrlCode, IntPtr pDeviceGUID);

        // timeswitch
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_TimeSwitch", CallingConvention = CallingConvention.StdCall)]
        ...
        // switch program
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_SwitchProgram", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_SwitchProgram(int nSendType, IntPtr pStrParams, int nProgramIndex, IntPtr pDeviceGUID);

        // Set ip
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_SetIP", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_Rt_SendScreen", CallingConvention = CallingConvention.StdCall)]
        ...
        // add realtimearea
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_Rt_AddRealAreaToScreen", CallingConvention = CallingConvention.StdCall)]
        public static extern int Hd_Rt_AddRealAreaToScreen(int nX, int nY, int nWidth, int nHeight, int nMaxPageCount);

        // send realtime text
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_Rt_SendRealTimeText", CallingConvention = CallingConvention.StdCall)]
        ...
        // send realtime image
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_Rt_SendRealTimeImage", CallingConvention = CallingConvention.StdCall)]
        ...
        // set screen params
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_SetScreenParam", CallingConvention = CallingConvention.StdCall)]
        ...
        // set program params
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_SetProgramParam", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddChineseCalendarAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddTempAndHumiAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // add count area item
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddCountAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // add digit area item
        [DllImport(LIBRARYNETSDK, EntryPoint = "Hd_AddDigitAreaItem", CallingConvention = CallingConvention.StdCall)]
        ...
        // clear realtime area
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_ClearRealtimeArea", CallingConvention = CallingConvention.StdCall)]
        public static extern int Cmd_ClearRealtimeArea(int nSendType, IntPtr pStrParams, IntPtr pDeviceGUID);

        // set digit state
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_SetDigitState", CallingConvention = CallingConvention.StdCall)]
        ...
        // set count state
        [DllImport(LIBRARYNETSDK, EntryPoint = "Cmd_SetCountState", CallingConvention = CallingConvention.StdCall)]
