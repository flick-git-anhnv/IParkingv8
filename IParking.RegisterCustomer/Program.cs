...
namespace IParking.RegisterCustomer
{
    ...
    {
        private const string appName = "IP_DA_V8_REGISTER_FACE";
        /// <summary>
        ...
        private static void LoadAppConfig()
        {
            ...
            SystemUtils.logger = Kztek.Tool.LoggerFactory.CreateLoggerService(AppData.AppConfig.LogServiceType, IparkingingPathManagement.baseBath);
        ...
        private static void LoadOEMConfig()
        {
            ...
            ImageHelper.ImageToBase64(resizeImg, out string base64, out int size);
