using IParking.RegisterCustomer;
...
namespace IParkingv8.Forms
{
    public partial class FrmLoading : Form
    {
            ...
            foreach (Bdk bdk in AppData.Controllers)
            {
                ...
                var controller =
                    ControllerFactory.CreateController(bdk.Id, bdk.Comport, bdk.Baudrate, bdk.Type, bdk.CommunicationType,
                                                       bdk.Name, AppData.AppConfig?.MinDelayCardTime ?? 5, ((EmPrintTemplate)AppData.AppConfig.PrintTemplate).ToString());
                if (controller != null)
                {
        ...
        private async Task<bool> CreateLpr()
        {
            ...
            AppData.LprDetecter = LprFactory.CreateLprDetecter(AppData.LprConfig, null);
            await AppData.LprDetecter!.CreateLprAsync(AppData.LprConfig);
