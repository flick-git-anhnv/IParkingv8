...
namespace HIKSDK
{
    public class CHCNetSDK
    {
        ...
        public const int NAME_LEN = 32;//Username length
        ...
        **************************************************/
        ...
        public struct NET_DVR_LAMP_CFG
        {
            public uint dwYear;
            public uint dwMonth;
            public uint dwDay;
  ...
  //      struct{
    ...
    public class CHCNetSDK
    {
		...
		public enum IVS_PARAM_KEY
		{
			...
			SUPPRESS_LAMP,
			MIN_OBJECT_SIZE,
			OBJECT_GENERATE_RATE,
			MISSING_OBJECT_HOLD,
			MAX_MISSING_DISTANCE,
			OBJECT_MERGE_SPEED,
		...
		[DllImport("HCNetSDK.dll")]
		public static extern int NET_DVR_RealPlay_V40(int iUserID, ref CHCNetSDK.NET_DVR_CLIENTINFO lpClientInfo, CHCNetSDK.REALDATACALLBACK fRealDataCallBack_V30, IntPtr pUser);
		[DllImport("HCNetSDK.dll")]
		public static extern bool NET_DVR_StopRealPlay(int iRealHandle);
		[DllImport("HCNetSDK.dll")]
		...
		[DllImport("HCNetSDK.dll")]
		public static extern bool NET_DVR_SetCapturePictureMode(uint dwCaptureMode);
		[DllImport("HCNetSDK.dll")]
        ...
        [DllImport("HCNetSDK.dll")]
        public static extern bool NET_DVR_GetDVRWorkState_V30(int lUserID, ref CHCNetSDK.NET_DVR_WORKSTATE_V30 lpWorkState);
		[DllImport("HCNetSDK.dll")]
