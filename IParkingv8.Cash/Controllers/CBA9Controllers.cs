...
//{
//    public class CBA9Controllers : ICashController
//    {
...
//        //{
//        //    bool isConnect = ConnectToValidator();
//        //    return is;
//        //}

//        private readonly PaymentKioskConfig paymentKioskConfig;
//        public CBA9Controllers(PaymentKioskConfig paymentKioskConfig)
//        {
...
//        {
//            GetComPort();
//            return await ConnectToValidator();
//        }
...
//                SerialPort serialPort = m_eSSP.comPort;
//                try
//                {
//                    DisableValidator();
//                }
...
//            }
//        }
//        public async void PollingGetEventFunc(CancellationToken token)
//        {
//            CashResult cash = new();
...
//                    try
//                    {
//                        //bool isConnect = await ConnectToValidator();
...
//                        DeviceId = "CASH",
//                        Cmd = "DoPoll",
//                        Description = $"Gửi lệnh POLL Nhận m_cmd.ResponseData = {m_cmd.ResponseDataLength} ",
//                    });
//                }
//                SystemUtils.logger.SaveDeviceLog(new DeviceLog()
//                {
...
//                            QueryRejection();
//                            break;
//                        // Tiền đang chuyển tới khay cuối
